...
interface MovieCardProps {
    data: {thumbnailUrl:string, duration:string, genre:string, id:string}
}
        ...
        <div className="group bg-zinc-900 col-span relative h-[12vw]">
            <img src={data.thumbnailUrl} alt="Movie" draggable={false} 
                className="cursor-pointer object-cover transition duration
                            ...
                            sm:group-hover:opacity-0 delay-300 w-full
                            h-[12vw]"
            />
          <div className="
            opacity-0
            ...
            <div className="
              ...
              <div className="flex flex-row items-center gap-3">
                ...
                <div className="cursor-pointer ml-auto group/item w-6 h-6 lg:w-10 lg:h-10 border-white border-2 rounded-full flex justify-center items-center transition hover:border-neutral-300">
                  <ChevronDownIcon onClick={() => openModal(data?.id)} className="text-white group-hover/item:text-neutral-300 w-4 lg:w-6" />
                </div>
              </div>
